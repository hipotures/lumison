...
Lumison is a planned piano/MIDI-driven audiovisual application powered by a shared thin-film visual engine. The repository currently includes the Fixed-compatible TFL Lab behind canonical state, coordinate, timing and source-neutral control boundaries, plus optional Phase 3A passive motion warp, Phase 3B active press/drag displacement and Phase 3C coordinate shear. All new spatial responses are experimental and default to off.
