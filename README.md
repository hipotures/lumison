...
Lumison is a planned piano/MIDI-driven audiovisual application powered by a shared thin-film visual engine. The repository currently includes the Fixed-compatible TFL Lab behind canonical state, coordinate, timing and source-neutral control boundaries, plus optional Phase 3A passive motion warp, Phase 3B active press/drag displacement, Phase 3C coordinate shear, Phase 3D timed ripple displacement, Phase 3E broad membrane interaction and Phase 3F displaced-geometry normal evaluation. All new spatial responses are experimental and default to off; Legacy Fixed remains the default normal mode, and TFL Lab provides Fixed, Qwen-like, Mobile-like and Custom interaction profiles for comparison.
