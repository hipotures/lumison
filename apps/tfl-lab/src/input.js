// Pointer Events adapter for Fixed compatibility. It translates browser
// events into the engine's existing numeric interaction state. Hover alone is
// non-destructive; deformation starts on primary-pointer down.
